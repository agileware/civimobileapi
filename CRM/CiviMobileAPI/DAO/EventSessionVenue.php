...
class CRM_CiviMobileAPI_DAO_EventSessionVenue extends CRM_Core_DAO {
   ...
   * @var string
   */
  static $_tableName = 'civicrm_civimobile_event_session_venue';
   ...
   * @var string
   */
  static $entityName = 'EventSessionVenue';
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'bao' => 'CRM_CiviMobileAPI_BAO_EventSessionVenue',
        ],
        'event_session_id' => [
